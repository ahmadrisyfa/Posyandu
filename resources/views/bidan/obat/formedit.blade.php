...
<main>
    <div class="container">
        <p class="mb-3">Data Obat/<span class="color-primary">Edit</span></p>
                ...
                <div class="col-xl-6 mr-auto">
                    <div class="form-group">
                        <label for="nama_obat">Nama Obat</label>
                            <input value="{{ old('nama_obat', @$obat->nama_obat) }}" type="text" class="form-control" name="nama_obat" id="nama_obat" placeholder="Nama Obat" readonly autofocus>
                            @if (count($errors) > 0)
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ old('jenis_obat', @$obat->jenis_obat) }}" type="text" class="form-control" name="jenis_obat" id="jenis_obat" placeholder="jenis Obat" readonly autofocus>
                    ...
                    <div class="form-group">
                        <label for="sisa_obat">Sisa Obat</label>
                            <input value="{{ old('sisa_obat', @$obat->sisa_obat) }}" type="number" class="form-control" name="sisa_obat" id="sisa_obat" placeholder="Sisa Obat" readonly autofocus>
                            @if (count($errors) > 0)
                                <div style="width: auto; color: #dc4c64; margin-top: 0.25rem;">
