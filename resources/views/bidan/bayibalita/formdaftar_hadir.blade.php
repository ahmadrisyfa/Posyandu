...
<main>
<div class="container">
        <p class="mb-3">Detail/<span class="color-primary">Tambah Data</span></p>
                ...
                <div class="col-xl-6 mr-auto">
                    ...
                    <div class="form-group">
                        <label for="ket">Keterangan</label>
                            <input value="{{ old('ket', @$daftar_hadirbayi->ket) }}" type="text" class="form-control" name="ket" id="ket" placeholder="Keterangan (isi - jika tidak ada ket)">
                            @if (count($errors) > 0)
                                <div style="width: auto; color: #dc4c64; margin-top: 0.25rem;">
                                {{ $errors->first('ket') }}
                                </div>
