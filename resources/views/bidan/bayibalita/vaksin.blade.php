    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 text-end mb-2">
                <a href="{{ url('vaksin_anak/create') }}" class="btn btn-primary">Tambah Data</a>
            </div>
            <div class="table-responsive">
                <table class="table table-striped" id="table-1">
                    ...
                    <tr>
                        ...
                        <td>{{ $item->ket }}</td>
                        <td>
                        <a href="{{route ('vaksinanak.edit', $item->id_vaksin) }}" 
                        onclick="javascript:return confirm(`Data ingin diubah ?`);" title="Edit">
                        <b>Edit</b> 
                        </a> |
                            <form action="{{ route('vaksinanak.destroy', $item->id_vaksin)}}" method="POST"
