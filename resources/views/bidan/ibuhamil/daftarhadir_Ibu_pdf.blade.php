...
<center>
    <h><b>Daftar Hadir Ibu Hamil</b></h>
    <p><b>Posyandu Mawar 1 Desa Sukadana</b></p>
</center>
<main style="margin-top: 30px">
    <div class="container">
    <p>Hari     :  </p>
    @if ($daftar_hadiribu->count() > 0)
    <p>Tanggal: {{ $daftar_hadiribu[0]->jadwal->tanggal_posyandu_ibuhamil}}</p>
    @else
        ...
        <div class="row">
            ...
            <table class='table table-bordered' border="1px">
                    ...
                    <tr>
                        ...
                        <th><center>Tanggal Posyandu</center></th>
