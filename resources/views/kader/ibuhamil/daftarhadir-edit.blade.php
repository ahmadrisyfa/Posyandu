<!-- Modal -->
<div class="modal fade" id="daftarhadir-edit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script>
    //button create event
    $('body').on('click', '#btn-edit-daftarhadir', function () {

        let item_id = $(this).data('id');

        //fetch detail with ajax
        $.ajax({
            ...
            success:function(response){
                ...
                //open modal
                $('#daftarhadir-edit').daftarhadir('show');
            }
        });
    });
    ...
    $('#update').click(function(e) {
        ...
        $.ajax({
            ...
            success:function(response){
                ...
                //append to data
                $(`#index_${response.data.id}`).replaceWith(daftarhadir);

                //close modal
                $('#daftarhadir-edit').modal('hide');
